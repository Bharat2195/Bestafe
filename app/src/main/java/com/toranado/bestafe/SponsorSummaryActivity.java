...
public class SponsorSummaryActivity extends AppCompatActivity {

    String strMemberID = "", strJsonResponse = "", strMessagge = "", strResult = "", strLevelNO = "", strCount = "", strSum = "";

    private static final String TAG = SponsorSummaryActivity.class.getSimpleName();
    ProgressDialog pd;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sponsor_summary);
        ...
        txtTitle.setText("Sponsor  Summary");
        ...
        try {
            jsonObject.put("mode", "sponsorsummry");
            jsonObject.put("earnedid", strMemberID);
    ...
    private class getBinaryLevelIncome extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pd = new ProgressDialog(SponsorSummaryActivity.this);
            ...
            try {
                ...
                if (!strMessagge.equals("No Data found")) {
                    ...
                    for (int i = 0; i < array.length(); i++) {
                        ...
                        strCount = object.getString("count(*)");
...
//                        listSum.add(strSum);
                    ...
                    if (listview_level_summary != null) {
                        CustomAdapter customAdapter = new CustomAdapter(SponsorSummaryActivity.this, R.layout.listview_item_level_summary, listDetails);
                        listview_level_summary.setAdapter(customAdapter);

                    } else {
                        Toast.makeText(SponsorSummaryActivity.this, "listview null", Toast.LENGTH_SHORT).show();
                    }
                } else {
    ...
    private class CustomAdapter extends ArrayAdapter<String> {
        ...
        public View getView(final int position, View convertView, ViewGroup parent) {
            ...
            holder.txtDetail.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    Intent intent = new Intent(SponsorSummaryActivity.this, SponsorSummaryClickActivity.class);
