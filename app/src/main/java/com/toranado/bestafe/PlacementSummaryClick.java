...
public class PlacementSummaryClick extends AppCompatActivity {

    private static final String TAG=PlacementSummaryClick.class.getSimpleName();
    ...
    ProgressDialog pd;
    ListView listview_detailbinary;
    private TextView txtTitle;
    private Toolbar toolbar_detailOfBinary;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_placement_summary_click);

        getSupportActionBar().hide();

        toolbar_detailOfBinary= (Toolbar) findViewById(R.id.toolbar_detailOfBinary);
        txtTitle= (TextView) toolbar_detailOfBinary.findViewById(R.id.txtTitle);
        ...
        toolbar_detailOfBinary.setNavigationIcon(R.drawable.arrowleft);
        toolbar_detailOfBinary.setNavigationOnClickListener(new View.OnClickListener() {
            @Override
        ...
        listview_detailbinary= (ListView) findViewById(R.id.listview_detailbinary);
        LayoutInflater inflater=getLayoutInflater();
        View view=inflater.inflate(R.layout.header_placement_summary_item,null);
        listview_detailbinary.addHeaderView(view);
...
//        Intent intent = getIntent();
    ...
    private void JsonResponse() {
        ...
        try {
            ...
            jsonObject.put("mode", "placementrsummrydetail");
    ...
    private class getReportData extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pd = new ProgressDialog(PlacementSummaryClick.this);
        ...
        protected void onPostExecute(String s) {
            ...
            try {
                ...
                if (!strMessage.equals("No Data found")){
                    ...
                    if (listview_detailbinary!=null){
                        CustomAdapter customAdapter = new CustomAdapter(PlacementSummaryClick.this, R.layout.list_item_placement_summary, listEntryDate);
                        listview_detailbinary.setAdapter(customAdapter);
                    }else {
                        Toast.makeText(PlacementSummaryClick.this, "Lisview null", Toast.LENGTH_SHORT).show();
                    }

                }else {
                    Toast.makeText(PlacementSummaryClick.this, "No data found", Toast.LENGTH_SHORT).show();
                    if (listview_detailbinary!=null){
                        CustomAdapter customAdapter = new CustomAdapter(PlacementSummaryClick.this, R.layout.list_item_placement_summary, listEntryDate);
                        listview_detailbinary.setAdapter(customAdapter);
                    }else {
